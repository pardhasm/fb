...
public class MergeMeetings implements Test {
    ...
    public void test(){
        List<Meeting> meetings = new ArrayList<>(List.of(new Meeting(0, 1), new Meeting(3, 5), new Meeting(4, 8), new Meeting(10, 12), new Meeting(9, 10)));
        MergeMeetings merges = new MergeMeetings();
        List<Meeting> result = mergeRanges(meetings);
    }
